...
export const BlogSection: React.FC = () => {
  ...
  return (
    <section id="blog" className="py-8 sm:py-16 md:py-20 bg-[#0A0A0A] text-white relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3.5 sm:gap-6">
          {blogPosts.map((post, idx) => (
            <motion.div
              ...
              className="group bg-neutral-900 border border-neutral-800 hover:border-orange-500/50 rounded-2xl overflow-hidden shadow-xl transition-all duration-300 flex flex-col justify-between cursor-pointer"
            >
              <div>
                {/* Image */}
                <div className="relative aspect-[16/9] overflow-hidden bg-neutral-950">
                  ...
                  />
                  <div className="absolute top-3 left-3 px-2.5 py-1 rounded-md bg-orange-500 text-white font-bold text-xs shadow">
                    {post.category}
                  </div>
                </div>
                ...
                <div className="p-5 space-y-3">
                  ...
                  <h3 className="text-base font-bold text-white group-hover:text-orange-400 transition leading-snug">
                    {post.title}
                  </h3>
              ...
              {/* Read More Footer */}
              <div className="px-5 pb-5 pt-2 flex items-center justify-between text-xs font-bold text-orange-400 group-hover:text-orange-300">
                <span className="flex items-center gap-1">
