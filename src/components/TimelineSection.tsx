      ...
      <div className="max-w-7xl 2xl:max-w-[1536px] mx-auto px-3.5 sm:px-6 lg:px-8 2xl:px-12 relative z-10">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <motion.div 
            ...
            className="absolute left-3.5 sm:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-orange-500 via-orange-500/50 to-amber-400 -translate-x-1/2 origin-top"
          />

          <div className="space-y-3.5 sm:space-y-12">
              ...
              return (
                ...
                >
                  ...
                  <div className="w-full sm:w-1/2 pl-8 sm:pl-0 sm:px-8">
                    <motion.div 
                      whileHover={{ y: -3 }}
                      className="bg-neutral-900/80 border border-neutral-800 hover:border-orange-500/50 p-3 sm:p-6 rounded-xl sm:rounded-2xl shadow-xl transition-all duration-300 group"
                    >
                      <div className="flex items-center justify-between mb-1 sm:mb-2">
                        <span className="px-2 py-0.5 sm:px-3 sm:py-1 rounded-md sm:rounded-lg bg-orange-500 text-white font-extrabold text-[10px] sm:text-sm shadow">
                          {item.year}
                        </span>
                        <Flame className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-orange-400 opacity-0 group-hover:opacity-100 transition" />
                      </div>
                      ...
                      <p className="text-[11px] sm:text-sm text-neutral-400 leading-tight sm:leading-relaxed mt-1 sm:mt-2">
                        {item.description}
                      </p>
                    </motion.div>
                  </div>
                  ...
                  {/* Center Node Pin */}
                  <div className="absolute left-3.5 sm:left-1/2 -translate-x-1/2 w-5 h-5 sm:w-8 sm:h-8 rounded-full bg-[#0E0E0E] border-2 border-orange-500 text-orange-400 flex items-center justify-center shadow-lg shadow-orange-500/30 z-10">
